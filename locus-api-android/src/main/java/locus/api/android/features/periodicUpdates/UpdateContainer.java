...
public class UpdateContainer extends Storable {
    ...
    protected TrackStats trackRecStats;
    ...
    protected String activeDashboardId;
    // ID of active running Live tracking
    protected String activeLiveTrackId;
     ...
     * ID of active running Live tracking.
     */
    public String getActiveLiveTrackId() {
        return activeLiveTrackId;
    }
